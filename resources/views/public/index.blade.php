            ...
            <div class=" px-[5%] h-full flex flex-col">
              <div class="h-[580px] md:h-[420px] mt-10 lg:mt-16">
                <div class="swiper slider_productos">
                                    ...
                                    <div class="bg-[#E6E4E5] h-[580px] md:h-[420px] gap-7 sm:gap-0 flex flex-col md:flex-row rounded-xl overflow-hidden">
                                        <div class="flex flex-col h-[300px] sm:h-[350px] md:h-full justify-start md:justify-center gap-6 w-full lg:w-1/2 text-left pt-6 md:pt-0 px-[5%] lg:pl-[5%] lg:pr-0">
                                            <h2 class="text-[#052F4E] font-maille text-text28 sm:text-4xl md:text-text44 leading-none line-clamp-3">
                                                Insumos de Calidad para Heladerías Excepcionales 1</h2>
                                            <p class="text-[#052F4E] font-galano_regular line-clamp-4">
                                                Sed non iaculis felis, eget egestas risus. Nullam vitae hendrerit purus. Suspendisse at sodales lectus. Nunc facilisis lorem id lacinia luctus.</p>
                                            <div class="flex flex-row items-start justify-start">
                                                <div class="text-white font-galano_semibold bg-[#052f4e] rounded-xl text-center w-auto py-2 px-6">Comprar ahora</div>
                                            </div>    
                                        </div>
                                        <div class="flex flex-col h-[280px] sm:h-[230px] md:h-full justify-center items-center w-full lg:w-1/2">
                                                <img src="{{ asset('images/imagen/helados.png') }}" alt="producto"
                    ...
                    <div class="swiper-pagination_productos !flex justify-center py-3 mt-3"></div>
                </div>
              </div>  
            </div>    
        </section>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 py-6 ">
                            ...
                            <div class="flex flex-col gap-2 p-3 bg-white rounded-xl">
                                <h2 class="text-[#052F4E] text-sm font-galano_regular line-clamp-5">
                                ...
                                <h2 class="text-[#052F4E] text-lg font-galano_medium leading-none">Años de Experiencia</h2>
                            </div>
            ...
            <section class="bg-[#F7F8F8]">
                <div class="flex flex-col gap-8 w-11/12 mx-auto py-20">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex flex-col gap-2">
                            <h2 class="text-[#082252] font-roboto font-bold text-text52 leading-tight">
                                Descubre Nuestras Categorías de Productos
                            </h2>
                            <p class="text-[#082252] font-roboto font-normal text-text22">
                                Explora nuestra amplia variedad de suplementos para heladerías. Cada categoría está diseñada para ayudarte a crear helados únicos y deliciosos que sorprenderán a tus clientes.
                            </p>
                        </div>
                        ...
                        <div class="flex justify-center items-center">
                            <a href="#"
                                class="text-white py-4 px-6 bg-[#FF5E14] rounded-xl font-roboto font-semibold text-center">
                                Ver todos los productos
                            </a>
                        </div>
